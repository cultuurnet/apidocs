...
As you may have noticed, your place has automatically gotten some extra properties. These are the default values for some of the various optional properties on place like [`status`](status.md) and `bookingAvailability`.
