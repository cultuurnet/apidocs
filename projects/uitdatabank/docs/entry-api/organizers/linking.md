...
You can link an organizer to your event or place via the organizer endpoint [`PUT /events/{eventId}/organizer`](/reference/entry.json/paths/~1events~1{eventId}~1organizer~1{organizerId}/put)
