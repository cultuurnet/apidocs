...
* [`PUT /organizers/{organizerId}/description`](/reference/entry.json/paths/~1organizers~1{organizerId}~1calendar/put) to update the [description](../shared/description.md)
